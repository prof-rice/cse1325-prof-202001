...
const std::string ELSA_VERSION = "1.3.0";
const std::string ELSA_FILE_VERSION = "1.2-simple";
const std::set<std::string> ELSA_FILE_COMPATIBLE =
    {"1.2-simple"}; // Cannot read 1.0-simple or 1.0
